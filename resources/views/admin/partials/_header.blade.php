...
<div class="header">
                        ...
                        <li class="nav-item dropdown notification_dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                {{--<div id="DZ_W_Notification1" class="widget-media dz-scroll p-3" style="height:380px;">--}}
                                    {{--<ul class="timeline">--}}
                                        {{--@if(count(\App\Helpers\NotificationHelper::getAdminUnreadNotice()) > 0)--}}
                                            {{--@foreach(\App\Helpers\NotificationHelper::getAdminUnreadNotice() as $notice)--}}
                                                {{--<li onclick="readNotice({{ $notice->id }})">--}}
                                                    {{--<div class="timeline-panel">--}}
                                                        {{--<div class="media-body">--}}
                                                            ...
                                                            {{--<small class="d-block">{{ \App\Helpers\CommonHelper::showDateTime($notice->created_at) }}</small>--}}
                                                        {{--</div>--}}
                                                    {{--</div>--}}
                                                {{--</li>--}}
                                            {{--@endforeach--}}
    ...
    {{--                            <a class="all-notification" href="javascript:void(0);">See all notifications <i class="ti-arrow-end"></i></a>--}}
                    ...
                    <li class="nav-item dropdown notification_dropdown change-fullscrin-icon-wrapper">
                        <a class="nav-link ai-icon change-fullscrin-icon" href="javascript:void(0);" onclick="fullScreen()" >
                            <i class="fas fa-expand"></i>
                        </a>
                    </li>
                    <li class="nav-item dropdown notification_dropdown">
                        <a class="nav-link ai-icon change-theme-icon" href="javascript:void(0);" onclick="changeTheme()" >
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                            ...
                            <div class="header-info ms-3">
                                ...
                                {{--<small>{{ \App\Helpers\CommonHelper::removeUnderscore(auth()->user()->role, true) }}</small>--}}
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end">
